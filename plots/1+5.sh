...
magick montage -mode Concatenate -tile 2x \( H1_D8LC2PvaimingzzYvEPo_H1-GDS-CALIB_STRAIN_spectrogram_1.0.png -resize 200% \) temporary1x2.png temporary1+2.png
magick montage -mode Concatenate -tile x2 temporary1+2.png temporary3x1.png subject_file/subject_file1+5.png 
rm temporary1x2.png
rm temporary3x1.png
rm temporary1+2.png
