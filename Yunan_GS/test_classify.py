...
MODEL_NAME_CNN = os.path.join(os.path.split(__file__)[0], 'models',
                              'O4_attention-classifier.hdf5')
SCRATCHY_TIMESERIES_PATH = os.path.join(os.path.split(__file__)[0],'gravityspy/tests', 'data',
                                        'timeseries',
...
RESULTS_TABLE = EventTable.read(os.path.join(os.path.split(__file__)[0], 'gravityspy/tests', 'data',
                                        'table',
