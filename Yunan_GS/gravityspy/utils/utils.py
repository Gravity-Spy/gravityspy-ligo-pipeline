...
def label_q_scans_new(plot_directory, path_to_cnn, **kwargs):
    ...
    classes = ['1080Lines', '1400Ripples', 'Air_Compressor', 'Blip', 'Blip_Low_Frequency', 'Chirp', 'Extremely_Loud', 
                'Fast_Scattering', 'Helix', 'Koi_Fish', 'Light_Modulation', 'Low_Frequency_Burst', 'Low_Frequency_Lines', 'No_Glitch', 'Paired_Doves', 'Power_Line', 
                'Repeating_Blips', 'Scattered_Light', 'Scratchy', 'Tomte', 'Violin_Mode', 'Wandering_Line', 'Whistle']
    if verbose:
    ...
    for image in list_of_images:
        ...
        image_data = read_image.read_data_new(os.path.join(plot_directory, image))
    ...
    scores, ml_label, ids, filename1, filename2, filename3, filename4 = \
         label_glitches.label_glitches_new(image_data=image_data_for_cnn,
